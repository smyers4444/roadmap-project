...
- `.github/copilot-instructions.md` for repo-specific architecture, conventions, and verification guidance.
...
Read `references/project-reference.md` when planning larger changes such as importer behavior, timeline layout changes, task model changes, or repo workflow updates.
